...
> Current release: `0.3.1`. Page translation defaults to English, and users may add more source languages and choose one target language. Publisher links are centralized provisional defaults; forks should update `src/config/branding.ts` before publishing.
...
1. Obtain `FloatRead-v0.3.1.zip` and verify its SHA-256 against the adjacent `.sha256` file.
